...
### 🚀 Featured Projects:
- **[Who Am I? - Game](https://whoamigame.app)**: A real-time multiplayer party game with dynamic rooms, round-based sync, and interactive live-voting. Built with Vanilla JS, Firebase Realtime Database, Capacitor, and Vite. Available on iOS & Android.
- **[Grid-Based Path Planning](https://github.com/batinkaska)**: Autonomous path planning simulation using the A* algorithm in a 2D grid environment. Built with Python and Matplotlib.
- **[Feinkost Kilic](https://feinkostkilic.com)**: Corporate website designed and developed for a local delicatessen.

### 📊 GitHub Stats:
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=batinkaska&show_icons=true&theme=radical" alt="batinkaska's GitHub stats" />
  <br/>
